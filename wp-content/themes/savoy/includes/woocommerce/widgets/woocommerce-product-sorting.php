...
class NM_WC_Widget_Product_Sorting extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description	= __( 'Display a product sorting list.', 'nm-framework-admin' );
		$this->widget_id          	= 'nm_woocommerce_widget_product_sorting';
		$this->widget_name        	= __( 'Product Sorting', 'nm-framework-admin' );
		$this->settings           	= array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Сортировка', 'nm-framework' ),
