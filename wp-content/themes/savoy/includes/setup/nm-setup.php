...
class NM_Setup {
	...
	function __construct() {
        ...
        $this->content_file_url = NM_DIR . '/setup/content/content.xml';
	...
	function view() {
		...
		<div class="nm-setup wrap">
            ...
            <div class="nm-setup-view card">
                ...
                <div class="nm-setup-spinner"><span class="spinner"></span></div>
			</div>
		</div>
	<?php
    }
	...
	function view_content() {
        ...
        <div class="nm-setup-summary">
            <p><?php esc_html_e( 'Do you want to import the demo content? Note that this can take some time.', 'nm-framework-admin' ); ?></p>
            <ul class="nm-setup-tasks nm-setup-tasks-content">
                <li class="nm-setup-task-content"><img src="<?php echo NM_URI . '/setup/assets/img/content-import.jpg'; ?>"><div>Content<span>Status: <?php echo $content_status; ?></span></div></li>
                <li class="nm-setup-task-settings"><img src="<?php echo NM_URI . '/setup/assets/img/content-settings.jpg'; ?>"><div>Settings<span>Status: <?php echo $settings_status; ?></span></div></li>
            </ul>
        </div>
        <div class="nm-setup-button-wrap">
	...
	function view_final() {
        ...
        <div class="nm-setup-info">
            ...
            <ul>
                ...
                <li><a href="<?php echo admin_url( 'index.php?page=wc-setup' ); ?>" class="dashicons-before dashicons-admin-settings"><?php esc_html_e( 'WooCommerce setup wizard', 'nm-framework-admin' ); ?></a></li>
    ...
    function content_install_import_content() {
        if ( file_exists( $this->content_file_url ) ) {
            ...
            $import->import( $this->content_file_url );
        }
    }
