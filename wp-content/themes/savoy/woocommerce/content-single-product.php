...
if ( $nm_theme_options['product_layout'] == 'scrolling' ) {
    $summary_pin_wrapper_open = '<div id="nm-summary-pin">';
    $summary_pin_wrapper_close = '</div>';
} else {
    $summary_pin_wrapper_open = '';
    $summary_pin_wrapper_close = '';
}

// Class: Main container
$post_class = 'nm-single-product layout-' . $nm_theme_options['product_layout'];
...
// Class: Thumbnails
$post_class .= ( $nm_theme_options['product_layout'] == 'default-thumbs-h' ) ? ' thumbnails-horizontal' : ' thumbnails-vertical';
// Class: Background color
$post_class .= ( $nm_theme_options['single_product_background_color'] == 'transparent' || isset( $_GET['nobg'] ) ) ? ' no-bg-color' : ' has-bg-color';
            ...
            <div class="nm-single-product-summary-row nm-row">
                <div class="nm-single-product-summary-col col-xs-12">
                    ...
                    <div class="summary entry-summary">
                        <?php echo $summary_pin_wrapper_open; ?>
                        <?php
                            /**
                        ...
                        ?>
                        <?php echo $summary_pin_wrapper_close; ?>
                    </div>
                </div>
            </div>
        </div>
