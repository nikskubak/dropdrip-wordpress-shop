...
class WC_Widget_Color_Filter extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_name        = __( 'Filter Products by Color (Deprecated)', 'nm-framework-admin' );
		parent::__construct();
	}
	...
	public function form( $instance ) {
        ...
        <p class="notice notice-warning" style="margin-top:16px;"><span style="display:block; padding:10px 0 12px;"><strong>Note:</strong> This widget is deprecated, please use the <a href="http://docs.nordicmade.com/savoy/#shop-product-variation-controls" target="_blank">new color options</a> instead.</span></p>
		<p>
			<label>
