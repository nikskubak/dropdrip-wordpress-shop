...
// Zoom
if ( $nm_theme_options['product_layout'] != 'scrolling' && $nm_globals['product_image_hover_zoom'] ) {
...
function nm_woocommerce_single_product_image_gallery_classes( $wrapper_classes ) {
...
add_filter( 'woocommerce_single_product_image_gallery_classes', 'nm_woocommerce_single_product_image_gallery_classes' );
...
<div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>" data-columns="<?php echo esc_attr( $columns ); ?>" style="opacity: 0; transition: opacity .25s ease-in-out;">
    ...
    <a href="#" id="nm-featured-video-link" class="nm-featured-video-link" data-mfp-src="<?php echo esc_url( $featured_video_url ); ?>">
